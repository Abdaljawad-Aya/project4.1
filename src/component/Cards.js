...
function Cards() {
    ...
    return (
        <div className="All">
         <div className='Card'>
            ...
            <div className="lower-container">
                <h3> Ali Saadi</h3>
                <p> This esteemed gentleman is iconically known for his jaw-dropping lively images, which once seen, you can’t help but stare mesmerized at his genius timings. Ali is a black-and-white photography specialist, whose photographs are so scarily alive, that if you look close enough, you might imagine the figures in motion!</p>
              </div>
        ...
        <div className='Card'>
            ...
            <div className="lower-container">
                <h3> Omar Khyami</h3>
                <p> A Creative Director and Director of Commercial Photography at Robina Studio, a graphic designer, a billboard and commercial photography specialist; Omar is the whole package of what a real moving talent ought to be. He shows passion for his work through a unique artistic touch seen clearly in his edgy photography. </p>
                 </div>
        </div>
        </div>
